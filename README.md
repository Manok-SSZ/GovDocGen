...
- **Poppler** (для конвертации PDF → JPG) — [скачать](https://github.com/oschwartz10612/poppler-windows/releases/)
...
GovDocGen/
│
├── GovDocGen.py               # Основная программа
